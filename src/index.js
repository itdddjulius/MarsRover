...
class App extends React.Component {
    ...
    render() {
        ...
        return (
            <div className={'app'}>
                <h1 className={'app-name'}>Julius Olatokunbo - Mars Rover React - v1.0</h1>
                <a className={'source'} href={'https://github.com/itdddjulius/MarsRover/'}
                   title={'GitHub Source - Julius Olatokunbo - Mars Rover React - v1.0'}>Source</a>
